    ...
    <>
      ...
      <DetailCard title="Entity Details" icon={<User className="w-5 h-5 text-green-600" />}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <DataField label="CAC Registration Number (RC Number)" value="RC1234567" />
          <DataField label="Entity Name" value="Sule Enterprises Ltd" />
          <DataField label="Preferred Company Email" value="info@examplebusiness.com" />
          <DataField label="Entity Type" value="Company Limited By Shares " />
        </div>
      </DetailCard>
      ...
      <DetailCard title="Authorized Officer Information" icon={<User className="w-5 h-5 text-green-600" />}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <DataField label="Email" value="sule@exampl.com" />
          <DataField label="Surname" value="Sule" />
          <DataField label="First Name" value="Madu" />
          <DataField label="Phone Number" value="1234567890" />
          <DataField label="Deignation" value="N/A" />
      ...
      <DetailCard title="Uploads" icon={<Upload className="w-5 h-5 text-green-600" />}>
        <div className="grid grid-cols-1 gap-4">
          <FilePreview label="Account Creation Form" />
          <FilePreview label="Upload Identity" />
        </div>
      </DetailCard>
    </>
  )
    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-3 p-4 border rounded-lg bg-white group cursor-pointer hover:border-green-500 transition-colors">
        ...
        <div className="flex-1">
          <p className="text-xs font-medium">CAC_Form.pdf</p>
