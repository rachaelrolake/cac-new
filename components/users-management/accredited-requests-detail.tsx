...
export default function RequestsAccreditionDetails() {
  ...
  return (
    <>
      ...
      <DetailCard title="Firm Details" icon={<Building2 className="w-5 h-5 text-green-600" />}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <DataField label="RC Number" value="RC123423" />
          <DataField label="Registered Company Name" value="Williams & Associates" />
        ...
        <div className="mt-6">
          <p className="font-semibold text-sm mb-4">Firm address</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <DetailCard title="Principal Officer(s) Details" icon={<User className="w-5 h-5 text-green-600" />}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <DataField label="Membership Number(s)" value="1234567890" />
          <DataField label="Role in Firm" value="Senior Officer" />
