...
const mockRequestInsolvencyAgents: User[] = [
  {
    id: 15,
...
export function InsolvencyAgentComponent() {
  ...
  const filteredUsers = mockInsolvencyAgents.filter((user) => {
        ...
        <Tabs defaultValue="approved-agents" className="w-full">
          <CardHeader className="border-b space-y-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <CardTitle className="text-lg">Accredited Agents ({filteredUsers.length})</CardTitle>
          ...
          <CardContent className="p-4"> {/* P-0 because Table handles internal padding */}
            ...
            <TabsContent value="approved-agents">
              <TheTable mockInsolvencyAgents={mockInsolvencyAgents} getStatusColor={getStatusColor} router={router} type="insolvency-approved" />
            </TabsContent>

            <TabsContent value="accreditation-requests">
              <TheTable mockInsolvencyAgents={mockRequestInsolvencyAgents} getStatusColor={getStatusColor} router={router} type="insolvency-requests" />
            </TabsContent>
...
function TheTable({ mockInsolvencyAgents, getStatusColor, router, type }: { mockInsolvencyAgents: any[], getStatusColor: any, router: any, type: string }) {
  return (
    <Table>
      ...
      <TableBody>
        {mockInsolvencyAgents.map((user, i) => (
