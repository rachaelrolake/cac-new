...
export function DashboardHeader({ headerTitle, headerSubTitle }: { headerTitle: string, headerSubTitle: string }) {
    ...
    <header className="border-b bg-white">
      <div className="flex h-20 items-center justify-between px-6">
        <div>
          ...
          {headerSubTitle && <p className="text-sm text-gray-500">{headerSubTitle}</p>}
        </div>
