...
export function MetricCard({ title, value, icon, iconColor, subtitle, percentage }: MetricCardProps) {
    ...
    <Card className="p-6">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className={`mt-1 text-sm ${percentage?.includes("+") ? "text-green-600" : "text-red-600"}`}>{percentage}</p>
