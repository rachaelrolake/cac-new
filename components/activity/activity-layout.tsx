      ...
      <div className={`flex flex-1 flex-col transition-all duration-300 ${isSidebarExpanded ? "ml-64" : "ml-20"}`}>
        <header className="border-b bg-white">
          <div className="flex h-20 items-center justify-between px-6">
            <div>
              ...
              <p className="text-sm text-gray-500">Complete history of all system actions and decisions</p>
            </div>
        ...
        <main className="flex-1 overflow-auto">
          ...
          <div className="p-8">
            ...
            <ActivityList activeCategory={activeCategory} setActiveCategory={setActiveCategory} />
          </div>
        </main>
      </div>
    </div>
