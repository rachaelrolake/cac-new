...
const data = [
  {
    sn: 1,
    name: "Registration and CTC of Registration Documents/extracts",
    desc: "N/A",
    feeAmount: "5,000",
  ...
  {
    sn: 5,
    name: "Status Report/Letter of Good Standing",
    desc: "(this  includes CTC of first  incorporation documents  without additional charge).  Issued share capital of  N1million or less",
    feeAmount: "5,000 each",
    createdAt: "Nov 14, 2025",
    timestamp: "1 min ago",
    createdBy: "Support"
  },
