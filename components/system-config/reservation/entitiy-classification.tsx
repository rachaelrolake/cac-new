...
const data = [
  { sn: 1, name: "Business Name", createdAt: "Nov 15, 2025", timestamp: "2hrs ago", createdBy: "Super Admin" },
  { sn: 2, name: "Company", createdAt: "Nov 14, 2025", timestamp: "1 min ago", createdBy: "Admin" },
  { sn: 3, name: "Incorporated Trustees", createdAt: "Nov 14, 2025", timestamp: "1 min ago", createdBy: "Support" },
  { sn: 4, name: "Limited Partnership (LP)", createdAt: "Nov 14, 2025", timestamp: "1 min ago", createdBy: "Support" },
  // ... rest of your data
]
      ...
      <div className="bg-white rounded-xl border shadow-sm p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-semibold text-gray-800">
            Entity Classification (Business Classification) (5)
          </h2>
        ...
        <div className="relative w-72 mb-6">
          ...
          <Input placeholder="Search Entity Classification" className="pl-10 bg-gray-50" />
        </div>
