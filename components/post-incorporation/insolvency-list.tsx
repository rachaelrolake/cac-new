...
export function InsolvencyList({ activeCategory, setActiveCategory }: InsolvencyListProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <CategoryTabs2 activeCategory={activeCategory} onCategoryChange={setActiveCategory} />
      </div>

      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5">
        {activeCategory === "company-insolvency" && (
          <>
            <MetricCard title="Total Company Insolvency Applications" value="200" icon="users" iconColor="blue" />
            <MetricCard title="Auto Approved Filings" value="120" icon="checkmark" iconColor="green" />
        ...
        {activeCategory === "llp-insolvency" && (
          <>
            <MetricCard title="Total Company Insolvency Applications" value="500" icon="users" iconColor="blue" />
            <MetricCard title="Auto Approved Filings" value="120" icon="checkmark" iconColor="green" />
