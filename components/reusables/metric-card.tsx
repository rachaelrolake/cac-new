...
import { TrendingUp, TrendingDown, CheckCircle2, XCircle, Clock, Users, Files, FilePlus, Building } from "lucide-react"

interface MetricCardProps {
  title: string
  value: string | number
  icon: "checkmark" | "cross" | "clock" | "trending-up" | "trending-down" | "users" | "files" | "filesplus" | "buildings"
