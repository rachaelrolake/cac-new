          ...
          <div className="p-8">
            <div className="flex justify-between items-center mb-10">
              ...
              <div className="flex gap-2">
                <Button variant="destructive" size="xl">Reject</Button>
                <Button variant="outline" size="xl" className="bg-orange-500 text-white hover:bg-orange-600">Query</Button>
                <Button variant="default" size="xl" className="bg-emerald-600 hover:bg-emerald-700">Approve</Button>
