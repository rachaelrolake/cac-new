...
class ConsentApplicationsAPI {
  ...
  async approveConsentApplication(type: string, id: string, payload: ApproveConsentPayload): Promise<void> {
    await apiClient.patch(`/admin/pre-incorporation/consent-applications/${type}/${id}/approve`, payload);
  }
